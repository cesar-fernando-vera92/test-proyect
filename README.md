...
Permite seleccionar ciertos productos, navegar a sus detalles, agregarlos al carrito, poder acceder a él, simular la compra de los productos de una tienda de relojeria.
...
## ScreenShots
![image00](https://i.postimg.cc/LsfnHXvR/imagen-Tienda.png)
![image01](https://i.postimg.cc/JnLttLdX/imagen-Categorias.png)
